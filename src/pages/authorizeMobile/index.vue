...
<template>
  <van-popup :show="show" position="bottom">
    <div class="pop">
      ...
      <p class="type">你的手机号码</p>
      <van-cell title="15642369581">
        <i class="label">微信绑定号码</i>
        <van-icon slot="right-icon" name="success" style="line-height: inherit;color: #05c160;font-size:16px;" />
      </van-cell>
